...
> ( 6h30m) Architecting with Google Kubernetes Engine: Production  
> ( 8h30m) Managing Security in Google Cloud  
> (11h15m) Security Best Practices in Google Cloud  
> ( 5h00m) Mitigating Security Vulnerabilities on Google Cloud  
> ( 6h30m) Getting Started with Terraform for Google Cloud  
> ( 8h30m) Security & Identity Fundamentals  
> ( 0h30m) Implement CI/CD Pipelines on Google Cloud  
...
> ( 8h00m) Custom Search with Embeddings in Vertex AI  
> ( 1h45m) Inspect Rich Documents with Gemini Multimodality and Multimodal RAG  
> ( 3h00m) Improving developer velocity with Gemini Code Assist  
> ( 5h00m) Integrate Vertex AI Search and Conversation into Voice and Chat Apps  
> ( 9h00m) Orchestrating Gen AI Applications with LangChain  
> ( 4h00m) Orchestrate LLM solutions with LangChain  
> ( 6h00m) Deploy, Test & Evaluate Gen AI Apps  
...
> ( 2h30m) Deploy a RAG application with vector search in Firestore  
> ( 2h00m) Evaluate Gen AI model and agent performance  
> ( 1h30m) Build search and recommendations applications with AI Applications  
> ( 1h30m) Configure AI Applications to optimize search results  
> ( 2h00m) Extend Gemini Enterprise Assistant Capabilities  
> ( 1h30m) Create media search and media recommendations applications with AI Applications  
> ( 5h00m) Integrate Vertex AI Search and Conversation into Voice and Chat Apps  
...
> (14h00m) Reliable Google Cloud Infrastructure: Design and Process  
> ( 8h30m) Logging and Monitoring in Google Cloud  
> ( 6h30m) Getting Started with Terraform for Google Cloud  
> ( 1h15m) Set Up an App Dev Environment on Google Cloud  
> ( 1h00m) Implement DevOps Workflows in Google Cloud  
...
> ( 5h15m) Working with Notebooks in Vertex AI  
> ( 0h30m) Create ML Models with BigQuery ML  
> ( 0h30m) Engineer Data for Predictive Modeling with BigQuery ML  
> (24h00m) Feature Engineering  
> (15h30m) Build, Train and Deploy ML Models with Keras on Google Cloud  
> (16h00m) Production Machine Learning Systems  
> ( 4h30m) Machine Learning Operations (MLOps): Getting Started  
> ( 8h00m) Machine Learning Operations (MLOps) with Vertex AI: Manage Features  
> ( 0h45m) Introduction to Generative AI  
> ( 1h00m) Introduction to Large Language Models  
> ( 0h30m) Machine Learning Operations (MLOps) for Generative AI  
> ( 2h30m) Machine Learning Operations (MLOps) with Vertex AI: Model Evaluation  
> ( 4h00m) Create Generative AI Apps on Google Cloud  
> ( 4h00m) Responsible AI for Developers: Fairness & Bias  
...
> (24h00m) API Security on Google Cloud's Apigee API Platform  
> (24h00m) API Development on Google Cloud's Apigee API Platform  
